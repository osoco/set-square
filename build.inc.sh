...
defineEnvVar REGISTRY_NAMESPACE MANDATORY "The namespace under the registry where the image is to be uploaded" '${NAMESPACE}';
defineEnvVar INCLUDES_FOLDER MANDATORY "The folder where 'include' files are located" "./.templates";
defineEnvVar COPYRIGHT_PREAMBLE_FILE MANDATORY "The file with the copyright preamble" 'copyright-preamble.gpl3';
defineEnvVar LICENSE_FILE MANDATORY "The file with the license details" 'LICENSE.gpl3';
